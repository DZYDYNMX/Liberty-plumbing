...
<head>
    ...
    <meta property="og:title" content="Liberty Plumbing | Expert Emergency Plumbers in {city}, TX">
...
<body>
    ...
    <main class="main-content">
        <section class="hero" style="background-image: url('assets/areas-hero.png');">
